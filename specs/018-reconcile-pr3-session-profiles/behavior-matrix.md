...
Baseline: current `dev` at `192f9bb19`. Candidate: fork PR 3 tip `781511c6d37412410c6d49c44f663f1ee06b25c8`, including hardening commit `38c082a8a`. Owner: Bead `jcode-anw`.
...
- Remaining: fresh-base validation, install/reload.
