...
/// Persisted values that can be selected for one headless `jcode run`.
///
...
#[cfg(test)]
mod session_profile_config_tests {
    use super::*;
    use serde_json::json;
    ...
    #[test]
    fn session_profile_omitted_fields_use_empty_optional_defaults() {
