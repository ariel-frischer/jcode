...
impl App {
    ...
    pub(super) fn refresh_keybindings_if_config_reloaded(&mut self) -> bool {
        ...
        self.open_model_picker_key = keybind::load_open_model_picker_key();
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            local_queued_message_editor: None,
            ...
            pending_handoff_resume_notice: None,
            ...
            pending_model_switch_from: None,
            ...
            open_model_picker_key: keybind::load_open_model_picker_key(),
            ...
            remote_soft_interrupt_recall: Default::default(),
            remote_queued_message_editor: Default::default(),
