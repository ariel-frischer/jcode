                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "feedback_loop_relevance": {
                                ...
                                "description": "How directly checks represent acceptance: indirect, synthetic, representative, blocked, or aligned."
                            },
                            "feedback_loop_coverage": {
                                "type": "string",
                                "enum": ["narrow", "main_paths", "edge_and_integration_paths"],
                                "description": "Check public interfaces, integration boundaries, edge cases, packaging, and likely failure modes."
                            },
                            "feedback_loop_traceability": {
                                "type": "string",
                                "enum": ["unmapped", "partial", "complete"],
                                "description": "How completely each requirement maps to checked evidence."
                            },
                            "delivery_state": {
                                "type": "string",
