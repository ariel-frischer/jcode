...
pub use jcode_harness_api::{
    ...
    ResponseStats, SessionInfo, SessionToolDefinition, SidePanelPage, SidePanelPageFormat,
    SidePanelPageSource, SidePanelSnapshot, TextMatch, ToolConfiguration, TurnStopReason,
    api_socket_path,
};
